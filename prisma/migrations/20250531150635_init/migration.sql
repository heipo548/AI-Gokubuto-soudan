...
CREATE TABLE "NannoJikanDayoClick" (
    ...
    CONSTRAINT "NannoJikanDayoClick_pkey" PRIMARY KEY ("id")
);
...
-- CreateIndex
CREATE INDEX "NannoJikanDayoClick_created_at_idx" ON "NannoJikanDayoClick"("created_at");
...
-- AddForeignKey
ALTER TABLE "Like" ADD CONSTRAINT "Like_question_id_fkey" FOREIGN KEY ("question_id") REFERENCES "Question"("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "NannoJikanDayoClick" ADD CONSTRAINT "NannoJikanDayoClick_question_id_fkey" FOREIGN KEY ("question_id") REFERENCES "Question"("id") ON DELETE CASCADE ON UPDATE CASCADE;
